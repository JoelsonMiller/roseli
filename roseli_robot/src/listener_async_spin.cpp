...
{
public:
  void odometry(const std_msgs::Int32::ConstPtr& msg)
  {
...
int main(int argc, char **argv)
{
  ...
  Listener l;
  ros::Subscriber sub1 = n.subscribe("/odom", 10, &Listener::odometry, &l);
  ros::Subscriber sub2 = n.subscribe("/chatter", 10, &Listener::driveline, &l);
